...
import com.kym.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter, KymUserDetailsService kymUserDetailsService) {
    ...
    public AuthenticationProvider authenticationProvider() {
        DaoAuthenticationProvider authenticationProvider = new DaoAuthenticationProvider(kymUserDetailsService);
