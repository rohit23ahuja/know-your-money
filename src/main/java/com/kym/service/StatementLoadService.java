...
public class StatementLoadService {
    ...
    public StatementLoadService(StatementFileRepository statementFileRepository,
                                StatementCellReader statementCellReader,
    ...
    public StatementLoadResponseDTO loadStatement(MultipartFile uploadedStatement) {
        ...
        List<StatementCell> statementCells = statementCellReader.readStatementCells(savedStatementFile.getId(), uploadedStatement);
